        ...
        if (email.isEmpty()) {
            ...
            if (c.list().isEmpty()) {
                ...
                new Thread(new Runnable() {
                    @Override
                    public void run() {
                       Mail.sendMail(email, "Woodora furniture Verification ", "<!DOCTYPE html>\n"
                                + "<html>\n"
                                + "<head>\n"
                                + "    <meta charset=\"UTF-8\">\n"
                                + "    <title>Woodora Furniture OTP Verification</title>\n"
                                + "</head>\n"
                                ...
                                + "        <h2 style=\"color: #333333;\">Woodora Furniture - OTP Verification</h2>\n"
                                + "        <p>Hi,</p>\n"
                                + "        <p>Use the following One-Time Password (OTP) to complete your action on <strong>Woodora Furniture</strong>.</p>\n"
                                + "        \n"
                                ...
                                + "\n"
                                + "        <p style=\"margin-top: 30px;\">Thank you,<br><strong>Woodora Team</strong></p>\n"
                                + "    </div>\n"
                                + "</body>\n"
                                + "</html>");
                    }
