...
public class Checkout extends HttpServlet {
    ...
    private static final int ORDER_PENDING = 2;
                ...
                if (fname.isEmpty()) {
                    ...
                    if (city == null) {
                        ...
                        if (line1.isEmpty()) {
                            ...
                            address.setLine_01(line1);
                            address.setLine_02(line2);
    ...
    private void processCheckout(Session s, Transaction transaction, User user, Address address, JsonObject responseObject) {
        try {
            ...
            for (Cart cart : cartList) {
                ...
                if (address.getCity().getName()== "Kandy") {
                ...
                SellersProduct product = cart.getProduct();
            ...
            PayHereJson.addProperty("notify_url", "  https://c2465aacdee8.ngrok-free.app/WoodoraFunitureOriginal/VerifyPayment");
            ...
            PayHereJson.addProperty("address",address.getLine_01()+ address.getLine_02());
